                ...
                try {
                    if (json.getString(KEY_SUCCESS) != null) {
                        ...
                        if(Integer.parseInt(res) == 1){
                            ...
                            //db.addUser(json_user.getString(KEY_FIRSTNAME),json_user.getString(KEY_LASTNAME),json_user.getString(KEY_EMAIL),json_user.getString(KEY_USERNAME),json_user.getString(KEY_UID),json_user.getString(KEY_COURSE_ONE),json_user.getString(KEY_COURSE_TWO),json_user.getString(KEY_COURSE_THREE),json_user.getString(KEY_CREATED_AT));
